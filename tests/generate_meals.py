...
def process_all_files(directory_path, max_workers=1, delay=10):
...
def main():
    # Since we're already in NUTRITION_TESTS, just use sample_jsons directly
    directory_path = r'user_profiles'
