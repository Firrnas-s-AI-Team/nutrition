...
async def generate_meal_plan_api():
    ...
    try:
        ...
        return JSONResponse(content={"meal_plan": plan_json})
    except json.JSONDecodeError:
        # If not valid JSON, return as plain text with line breaks
        formatted_plan = nutrition_plan.replace("\n", "<br>")  # Replace newlines with <br> for better readability
        return JSONResponse(content={"meal_plan": formatted_plan})
